...
parser.add_argument(
    ...
    action="store",
    type=str,
    # default="/home/pragyanb/biasbench/data/dropout_ft_data/checkpoints/dropout_c-gpt2_s-0/checkpoint-2000",
...
if __name__ == "__main__":
    ...
    if args.model_name_or_path == "openlm-research/open_llama_13b":
