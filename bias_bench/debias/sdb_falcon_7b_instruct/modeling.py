from transformers import PreTrainedModel, LogitsProcessor, LogitsProcessorList, PreTrainedTokenizer
...
from sdb_falcon_7b_instruct.configuration import SelfDebiasingAutoConfig
...
class SelfDebiasingAutoModelForCausalLM(PreTrainedModel, GenerationMixin):
    """
    ...
    """
    config_class = SelfDebiasingAutoConfig
    ...
    def new_logits_processor(self, *args, **kwargs):
        self.logits_processor = SelfDebiasingLogitsProcessor(*args, **kwargs)
