...
parser.add_argument(
    ...
    action="store",
    type=str,
    default="SentenceDebiasAutoModelForCausalLM",
    choices=[
...
parser.add_argument(
    ...
    choices=["bert-base-uncased", "albert-base-v2", "roberta-base", "gpt2", "gpt2-xl", "EleutherAI/pythia-6.9b", "gpt2-medium", "gpt2-large", "EleutherAI/gpt-j-6B", "openlm-research/open_llama_13b"],
...
if __name__ == "__main__":
    ...
    # print('here')
    # model._model.init_logits_processor()
    # model._model.new_logits_processor()
    # print(dir(model._model))
    ...
    # inputs = tokenizer.encode('The poet can rhyme', return_tensors='pt')
    # outputs = model._model(inputs.to('cuda'))
    ...
    path_to_json=f"{args.persistent_dir}/results/stereoset/{experiment_id}.json"
    ...
    call = str("python stereoset_evaluation.py --predictions_file " + path_to_json)
