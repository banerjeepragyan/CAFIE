...
parser.add_argument(
    ...
    type=str,
    default="gpt2-xl",
    choices=["bert-base-uncased", "albert-base-v2", "roberta-base", "gpt2", "t5-large"],
...
if __name__ == "__main__":
    ...
    if args.model_name_or_path == 'tiiuae/falcon-40b':
        experiment_id = generate_experiment_id(
        name="stereoset",
        model=args.model,
    ...
    print(f"{args.persistent_dir}/results/stereoset/{experiment_id}.json")
    ...
    with open(
        f"{args.persistent_dir}/results/stereoset/{experiment_id}_impl-prefix3.json", "w"
    ) as f:
