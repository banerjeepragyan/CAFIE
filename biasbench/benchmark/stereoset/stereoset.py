...
DEBIASING_PREFIXES = {
    ...
    "profession": "The following text discriminates against people because of their profession: ",
}
        ...
        for cluster in tqdm(clusters):
            ...
            for sentence in cluster.sentences:
                ...
                if self._is_self_debias:
                    ...
                    probs = torch.softmax(
                        logits[1, bias_type_to_position[self._bias_type] - 1]/self.temp, dim=-1
                    )
